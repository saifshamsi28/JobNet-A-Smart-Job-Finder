...
public class EditProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        inputEmail = view.findViewById(R.id.input_profile_email);
        inputPhone = view.findViewById(R.id.input_profile_phone);
        inputSkills = view.findViewById(R.id.input_profile_skills);
        btnSave = view.findViewById(R.id.btn_save_profile);
        progressSave = view.findViewById(R.id.progress_save_profile);

        applyInsets(view);
        prefillFromSession();
        loadProfile();

        view.findViewById(R.id.btn_back_edit_profile).setOnClickListener(v ->
    ...
    private void submitChanges() {
        ...
        if (name.isEmpty()) {
            inputName.setError(getString(R.string.edit_profile_invalid_name));
            inputName.requestFocus();
            return;
        }

        if (email.isEmpty() || !Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
            inputEmail.setError(getString(R.string.edit_profile_invalid_email));
    ...
    private void setLoading(boolean loading) {
        ...
        btnSave.setText(loading ? R.string.edit_profile_saving : R.string.edit_profile_save);
    }

    private void applyInsets(View root) {
        View toolbar = root.findViewById(R.id.toolbar_edit_profile);
        View actionBar = root.findViewById(R.id.edit_profile_action_bar);
        View scroll = root.findViewById(R.id.edit_profile_scroll);
